...
<body>
  <a href="\ProiectBD\tabele\doctori.php">Inapoi</a>
...
echo "<h1> Adaugare doctor nou: $numeNou $prenumeNou </h1>";

$sql = "INSERT INTO Doctori VALUES (NULL, '$numeNou', '$prenumeNou', '$stradaNou',
        '$numarNou', '$orasNou', '$judetNou', '$telefonNou', '$cnpNou', '$datanNou')";
